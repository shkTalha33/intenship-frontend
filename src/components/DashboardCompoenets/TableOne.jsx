...
import BrandOne from '../../assets/images/dashboard-images/brand/brand-01.svg';
import BrandTwo from '../../assets/images/dashboard-images/brand/brand-02.svg';
import BrandThree from '../../assets/images/dashboard-images/brand/brand-03.svg';
import BrandFour from '../../assets/images/dashboard-images/brand/brand-04.svg';
import BrandFive from '../../assets/images/dashboard-images/brand/brand-05.svg';
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col">
        ...
        {/* Repeat the pattern for other brand entries (BrandFour, BrandFive, etc.) */}
      </div>
    </div>
  );
};
